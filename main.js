...
global.owner = ['6281233107475'] // Put your number here
...
try {
  ...
  // no bot sendiri
  let bottt = "6285156149088@s.whatsapp.net"
  // gc ajg
  // let ajg = "6281233107475-1602089802@g.us"
  // klo user ga di ban
  if(m.sender !== bottt){
    ...
    else if (m.text.match(/(ahda firly barori|ahda)/gi)) {
      conn.updatePresence(m.chat, Presence.composing)
      // conn.sendFile(m.chat, 'media/ah.Ogg', 'tts.Ogg', null, m, true)
      // conn.sendFile(m.chat, 'media/ah1.Ogg', 'tts.Ogg', null, m, true)
      // conn.sendFile(m.chat, 'media/ah2.Ogg', 'tts.Ogg', null, m, true)
      conn.sendFile(m.chat, 'media/ah1.Ogg', 'tts.Ogg', null, m, true)
      // conn.sendFile(m.chat, 'media/ah.Ogg', 'tts.Ogg', null, m, true)
    }
  }
